    ...
    var // currently active contextMenu trigger
        ...
        defaults = {
            ...
            classNames: {
                ...
                iconEdit: 'context-menu-icon-bars',
				...
				iconSave: 'context-menu-icon-save',
				iconLoad: 'context-menu-icon-load',
				iconInput: 'context-menu-icon-input',
				iconOutput: 'context-menu-icon-output',
				iconSettings: 'context-menu-icon-settings',
				iconLedOn: 'context-menu-icon-ledon',
				iconLedOff: 'context-menu-icon-ledoff',
				iconClickOn: 'context-menu-icon-clickon',
				iconClickOff: 'context-menu-icon-clickoff',
